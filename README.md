...
`Prisma Schema`: Esquema do banco de dados.
`Prisma Cliente`: Tabelas convertidas para objetos em typescript para podermos trabalhar com eles.
`Prisma generate`: Atualiza/gera o Prisma Client
